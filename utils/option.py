...
# data specifications 
parser.add_argument('--dir_image', type=str, default='/home/mayikun',
                    help='image dataset directory')
parser.add_argument('--dir_mask', type=str, default='/home/mayikun',
...
parser.add_argument('--save_every', type=int, default=5e3,
                    help='frequency for saving models')
parser.add_argument('--save_dir', type=str, default='/home/mayikun',
...
parser.add_argument('--pre_train', type=str, default='/home/mayikun/AIGC/Inpainting_GAN/checkpoints/G0185000.pt',
                    help='path to pretrained models')
parser.add_argument('--outputs', type=str, default='/home/mayikun',
